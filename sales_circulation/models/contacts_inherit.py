...
class RegionZone(models.Model):
    ...
    Freebee_Quantity = fields.Float(string="Free copies", compute='_conmpute_all_copies')
    newspaper_quantity = fields.Float(string="Agent copies", compute='_conmpute_all_copies')
    Postal_copies = fields.Float(string="Postal copies", compute='_conmpute_all_copies')
    voucher_copies = fields.Float(string="voucher copies", compute='_conmpute_all_copies')
    promotional_copies = fields.Float(string="promotional copies", compute='_conmpute_all_copies')
    corresspondents_copies = fields.Float(string="corresspondent's copies", compute='_conmpute_all_copies')
    office_copies = fields.Float(string="office copies", compute='_conmpute_all_copies')
    total_copies = fields.Float(string="Total No of Copies", compute='_compute_total_copies')
...
class res_partner(models.Model):
    ...
    #     tracking=3, default='inactive')

    # @api.constrains('active_agent')
    # def state_change(self):
    #     for rec in self:
    #         if rec.active_agent == True:
    #             rec.state = 'active'
    #         else:
    #             rec.state = 'inactive'
    ...
    # Agent details
    unit_code = fields.Integer('Unit Code')
    ...
    Freebee_Quantity = fields.Float(string="Free copies", compute='compute_total_copies')
    newspaper_quantity = fields.Float(string="Agent copies", compute='compute_total_copies')
    Postal_copies = fields.Float(string="Postal copies", compute='compute_total_copies')
    voucher_copies = fields.Float(string="voucher copies", compute='compute_total_copies')
    promotional_copies = fields.Float(string="promotional copies", compute='compute_total_copies')
    corresspondents_copies = fields.Float(string="corresspondent's copies", compute='compute_total_copies')
    office_copies = fields.Float(string="office copies", compute='compute_total_copies')
    total_copies = fields.Float(string="Total No of Copies", compute='_compute_total_copies')
    ...
    # for zones
    f_q_zone = fields.Float(string="Free copies")
    n_q_zone = fields.Float(string="Agent copies")
    p_q_zone = fields.Float(string="Postal copies")
    v_q_zone = fields.Float(string="voucher copies")
    pr_q_zone = fields.Float(string="promotional copies",
                             )
    c_c_zone = fields.Float(string="corresspondent's copies",
                            )
    o_q_zone = fields.Float(string="office copies")
    t_c_zone = fields.Float(string="Total No of Copies", compute='_compute_t_co')
...
class AddZonesToLine(models.Model):
    ...
    Freebee_Quantity_zone = fields.Float(string="Free copies", readonly=False)
    newspaper_quantity_zone = fields.Float(string="Agent copies", readonly=False)
    Postal_copies_zone = fields.Float(string="Postal copies", readonly=False)
    voucher_copies_zone = fields.Float(string="voucher copies", readonly=False)
    promotional_copies_zone = fields.Float(string="promotional copies",
                                           readonly=False)
    corresspondents_copies_zone = fields.Float(string="corresspondent's copies",
                                               readonly=False)
    office_copies_zone = fields.Float(string="office copies", readonly=False)
    total_copies_zone = fields.Float(string="Total No of Copies", compute='_compute_total_copies')
